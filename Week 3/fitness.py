...
def main():
    ...
    birth_str = input("When were you born?(YYYY-MM-DD) ")
    inches = float(input("How tall are you?(Inches) "))
    pounds = float(input("How much do you weigh?(lb) "))
    ...
    print(f"Age (years): {age}\nWeight (kg): {weight:1.2f}\nHeight (cm): {height:1.1f}"
...
# this program will start executing.s